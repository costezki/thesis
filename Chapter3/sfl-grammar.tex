...
%%%
The graphical notations introduced by \citet{Halliday2013} are useful in reading and writing system networks in this thesis. Gigure \ref{fig:system-network-notation1} is a system network with a simple \textit{entry condition}, a \textit{system network grouping} that share the same entry condition is showin in Figure \ref{fig:system-network-notation2}, a system network with a \textit{disjunctive} and \textit{conjunctive} entry conditions is showin in Figures \ref{fig:system-network-notation3} and \ref{fig:system-network-notation4}. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[!ht]
    \centering
    \begin{tikzpicture}[]
