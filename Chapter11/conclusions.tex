...
\todo{A deduction made on the basis of the main body (i.e. Concluding statements)}
\todo{The writer’s personal opinion on what has been discussed}


\section{A final word}
\todo{half to one page max}