...
\section{Practical applications}
    ...
    %The current implementation can be used to the extent the perform ace and accuracy is deemed acceptable. 
...
\subsection{Nominal, Quality, Quantity and other groups of the Cardiff grammar}
    ...
    %(and other research must exist on adverbial groups of which I am not aware at the moment) 
