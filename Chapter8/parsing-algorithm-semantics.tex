...
\label{sec:mood-patterns}
    ...
    This section describes how the patterns look and how they were created. An extended representation of all the patterns is provided in Appendix \ref{ch:graph-patterns-some}.
           		...
           		\For {\Element \KwTo list of Wh-elements in \cg}
           			{
        				...
        				\For(low to high){\Group \KwTo \cg}
        					{\If{Wh-group is \textbf{not} Subject \textbf{AND}\\ Wh-group is \textbf{not} in lowest embedded clause}
        						...
        						{create Theta Wh-trace using \dg and \cg}
        						}
        					}	
           			}
    		}
...
\label{sec:claning-ptdb}
    ...
    \begin{table}[!ht]
    	...
    	\begin{tabulary}{\textwidth}{|l|L|L|}
    		...
    		1/A             & Form                                 & Form                                                      \\ \hline
    		2/B    & \textit{Occurrences of form}          & \textit{Occurrences of form}                               \\ \hline
    		3/C             & COB class (\& figure where possible) & COB class (\& figure where possible)                      \\ \hline
    		4/D             & meaning description                   & meaning description                                        \\ \hline
    		5/E             & Occurrences in 5 million words        & Occurrences in 5 million words                             \\ \hline
    		6/F    & \textit{Cardiff Grammar feature}     & \textit{Cardiff Grammar process type (re-indexed/renamed)} \\ \hline
