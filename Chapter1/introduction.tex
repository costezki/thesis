...
%todo copied
%The problem in using SFGs for parsing, as we have seen in Section \ref{sec:problem} above, manifests when the grammar is instantiated computationally with a primary focus on paradigmatic organisation (prevalent in SFL) at the cost of syntagmatics. 

%todo NOT copied
%The problem in using SFGs for parsing is that they are very large and complex. 
